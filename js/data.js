  ...
  posts: [
    {
      ...
      body: [
        ...
        { kind: "list", style: "bullet", items: [
          ...
          { title: "Accessiblity guidelines.", text: "A WCAG-led pass: contrast, focus order, target size, labels, and whether the page still works without a mouse. The bar is a published standard, not an opinion." }
        ]},
        ...
        { kind: "paragraph", text: "And that's the actual point. The value isn't that the first check is right. It's that it's cheap enough that me being the filter costs almost nothing. I spend my time deciding which findings are real and which fix is worth building, not making screenshots and formatting slides. I add findings AI has missed, and I helps me get ideas I wouldn't have gotten without. The slow, low-judgement part is gone. My focus is on enriching the data. The part that needs a designer is the only part left." },
