window.LV_DATA = {
  ...
  posts: [
    ...
    },
    {
      ...
      body: [
        "Here is a confession from someone who designs things: I spent years being told to design for everyone. Widen the funnel, lower the floor, make sure a teenager and a CFO both get it on the first try. So watching Anthropic do the exact opposite and pull ahead has been quietly satisfying.",
        "Because ChatGPT had every head start a product can ask for. A year of consumer mindshare ahead of Claude, a household name, the most-downloaded app of the decade. By early 2026 it still had over 900 million weekly users and around 25 billion dollars in annualized revenue. And yet Anthropic now runs ahead on revenue, with analysts starting to float it as one of the highest-revenue companies of the decade. How did that happen in three years?",
        ...
        "From there, the math gets interesting. Everyone is the most expensive user group you can design for. When the brief is mass market, every decision turns into a compromise: onboarding tuned for the median, guardrails set for the middle, surface area that only ever grows. It is a tax nobody on the team feels until they try to ship. Anthropic skipped it and built Claude Code, a tool for a developer writing code in a terminal, shaped to exactly that work. It went from launch to 2.5 billion dollars in annualized revenue in roughly a year, more than half of it from enterprise.",
        "And then they earned the right to expand. The desktop client came after Claude Code, then Cowork, both built for the people who sit next to developers: product managers, designers, ops, support. Same model underneath, shaped differently for each role. A developer who pays for Claude brings it into the team. The team brings it into the company. A ten-seat engineering contract becomes a hundred seats across functions. That is the shape of developer-first B2B growth, and it is why roughly 80 percent of Anthropic's revenue comes from API and enterprise, and only 10 to 15 percent from consumer subscriptions.",
        "None of this lands without a model good enough to carry it. Claude Opus is an asset on its own. It shows up in Cursor and dozens of other products precisely because it is the strongest model for the work developers care about. The focus on one user group and the quality of the model compound on each other (neither alone would have been enough).",
